...
export const mockPautas: PautaResponseDTO[] = [
    {
        ...
        titulo: 'Criação de Biblioteca 24 h',
        descricao:
            'Proposta para estender o horário de funcionamento da biblioteca para 24 h.',
        status: 'NAO_VOTADA',
    },
    {
        id: 2,
        ...
        descricao:
            'Instalar pontos de acesso Wi-Fi de alta velocidade nas áreas comuns do campus.',
        status: 'EM_VOTACAO',
    },
    {
        id: 3,
        ...
        descricao:
            'Organização de uma semana de palestras e workshops sobre inovação tecnológica.',
        status: 'VOTADA',
    },
];
